...
def straight(x):
    ...
    for i in range(0,len(nums)-1):
        if nums[i] + 1 != nums[i+1]:
            return(False, 0)
    return(True, nums[len(nums)-1])

    
def flush(x):
    suits = []
    for i in x:
        suits.append(suit[i[1]])
    nums = []
    for i in x:
        nums.append(val[i[0]])
    for i in range(0,len(suits)-1):
        if suits[i] != suits[i+1]:
            return(False, 0)
    return(True,suits[0],max(nums))

def royal(x):
    if straight(x)[0] and flush(x)[0]:
        if flush(x)[1] == 3 and straight(x)[1] == 13:
            return(True)
    return(False,0)

def straightflush(x):
    if straight(x)[0] and flush(x)[0]:
        return(True,straight(x)[1],flush(x)[1])
    return(False,0,0)
...
def full(x):
    ...
    for i in x:
        nums.append(val[i[0]])
    nums = sorted(nums)
    if nums.count(nums[0]) == 3 and nums.count(nums[4]) == 2:
        return(True,nums[0])
    if nums.count(nums[4]) == 3 and nums.count(nums[0]) == 2:
        return(True,nums[4])
    return(False,0)
...
def pair(x):
    ...
    for i in range(0,len(nums)-1):
        if nums.count(nums[i]) == 2:
            ...
            hand.remove(nums[i])
            hand = sorted(hand)
            return(True,nums[i],hand[2],hand[1],hand[0])
    return(False,0)
    ...
    if pair(x)[0] == True:
        ...
        for i in range(0,2):
            if nums.count(nums[i]) == 2:
                ...
                hand.remove(nums[i])
                hand.remove(nums[i])
                #max = higher pair min = lower pair hand[0] = lone card
                return(True,max(pair(x)[1],second),min(pair(x)[1],second),hand[0])
...
for i in range(0,len(p1)):
    ...
    player2 = p2[i]
    while True:
        # if royal(player1) and not royal(player2):
        #     total += 1
        #     break
        # if royal(player2) and not royal(player1):
        #     break
        # if straightflush(player1)[0] and not straightflush(player2)[0]:
        #     total += 1
        #     break
        # if straightflush(player2)[0] and not straightflush(player1)[0]:
        #     break
        # if straightflush(player2)[0] and straightflush(player1)[0]:
        #     if straightflush(player1)[1] > straightflush(player2)[1]:
        #         total += 1
        #         break
        #     elif straightflush(player1)[1] < straightflush(player2)[1]:
        #         break
        #     elif straightflush(player1)[1] == straightflush(player2)[1]:
        #         if straightflush(player1)[2] > straightflush(player2)[2]:
        #             total += 1
        #             break
        #         else:
        #             break
        # if fourkind(player1)[0] and not fourkind(player2)[0]:
        #     total += 1
        #     break
        # if fourkind(player2)[0] and not fourkind(player1)[0]:
        #     break
        # if fourkind(player2)[0] and fourkind(player1)[0]:
        #     if fourkind(player1)[1] > fourkind(player2)[1]:
        #         total += 1
        #         break
        #     else:
        #         break
        if full(player1)[0] and not full(player2)[0]:
            total += 1
            break
        if full(player2)[0] and not full(player1)[0]:
            break
        # if full(player2)[0] and full(player1)[0]:
        #     if full(player1)[1] > full(player2)[1]:
        #         total += 1
        #         break
        #     else:
        #         break
        if flush(player1)[0] and not flush(player2)[0]:
            total += 1
            break
        if flush(player2)[0] and not flush(player1)[0]:
            break
        # if flush(player2)[0] and flush(player1)[0]:
        #     if flush(player1)[2] > flush(player2)[2]:
        #         total += 1
        #         break
        #     elif flush(player2)[2] > flush(player1)[2]:
        #         break
        #     elif flush(player2)[2] == flush(player1)[2]:
        #         if flush(player1)[1] > flush(player2)[1]:
        #             total += 1
        #             break
        #         else:
        #             break
        if straight(player1)[0] and not straight(player2)[0]:
            total += 1
            break
        if straight(player2)[0] and not straight(player1)[0]:
            break
        # if straight(player2)[0] and straight(player1)[0]:
        #     if straight(player1)[1] > straight(player2)[1]:
        #         total += 1
        #         break
        #     else:
        #         break
        if three(player1)[0] and not three(player2)[0]:
            total += 1
            break
        if three(player2)[0] and not three(player1)[0]:
            break
        # if three(player2)[0] and  three(player1)[0]:
        #     if three(player1)[1] > three(player2)[1]:
        #         total += 1
        #         break
        #     else:
        #         break
        if twopair(player1)[0] and not twopair(player2)[0]:
            total += 1
            break
        if twopair(player2)[0] and not twopair(player1)[0]:
            break
        # if twopair(player2)[0] and twopair(player1)[0]:
        #     if twopair(player1)[1] > twopair(player2)[1]:
        #         total += 1
        #         break
        #     elif twopair(player2)[1] > twopair(player1)[1]:
        #         break
        #     elif twopair(player2)[1] == twopair(player1)[1]:
        #         if twopair(player1)[2] > twopair(player2)[2]:
        #             total += 1
        #             break
        #         elif twopair(player2)[2] > twopair(player1)[2]:
        #             break
        #         elif twopair(player2)[2] == twopair(player1)[2]:
        #             if twopair(player1)[3] > twopair(player2)[3]:
        #                 total += 1
        #                 break
        #             elif twopair(player2)[3] > twopair(player1)[3]:
        #                 break
        #             elif twopair(player2)[3] == twopair(player1)[3]:
        #                 total += 0.5
        #                 break
        if pair(player1)[0] and not pair(player2)[0]:
            total += 1
            break
        if pair(player2)[0] and not pair(player1)[0]:
            break
        if pair(player2)[0] and pair(player1)[0]:
            if pair(player1)[1] > pair(player2)[1]:
                total += 1
                break
            elif pair(player2)[1] > pair(player1)[1]:
                break
            # elif pair(player2)[1] == pair(player1)[1]:
            #     print(player1,player2)
            #     totaled = False
            #     for i in range(2,5):
            #         if pair(player1)[i] > pair(player2)[i]:
            #             total += 1
            #             totaled = True
            #             break
            #     if pair(player1)[4] == pair(player1)[4] and totaled == False:
            #         print(player1,player2)
            #         total += 0.5
            #         break
            #     break
...
# # print(straightflush(['TS','JS','QS','KS','1S']))
# twopair(['TS','KS','KS','1S','1S'])
# print(twopair(['TS','KS','KS','1S','1S']))

# print(high(['3D', '6D', '7D', 'TD', 'QD']))
